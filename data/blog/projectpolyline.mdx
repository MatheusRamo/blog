---
title: 'Projetar Polyline From Profile View'
date: '2024-07-01'
lastmod: '2024-07-01'
tags: ['Civil3D', 'C#', 'Plugins']
draft: false
summary: 'Neste primeiro post eu mostro cada etapa detalhada do comando que eu criei utilizando a API C# do Civil3D'

---

## Introdução

No meu trabalho, durante o ajuste de superfícies, um dos meus principais desafios é realizar esse ajuste de forma rápida e precisa.
A falta de um comando que me permita desenhar diretamente no Profile View e, assim, criar uma Polyline 3D no local desejado 
para usá-la como uma Breakline na superfície, foi o que me motivou a desenvolver o seguinte comando usando a API C# do Civil 3D.

![Project Polyline](https://github.com/MatheusRamo/Project-Polyline/assets/54686264/bcb3a157-a9ce-4126-98ea-631e731ce1a6)

Com esse comando, posso desenhar uma Polyline diretamente no Profile View e,  em seguida, projetar essa Polyline como uma Polyline 3D 
para utilizá-la como Breakline na superfície. Para desenvolver esse comando, foi necessario os seguintes passos:

1. Selecionar uma Polyline existente.
2. Escolher um Profile View.
3. Criar um Profile vazio.
4. Extrair as informações de geometria da Polyline e adiciona-las ao Profile vazio.
5. Criar uma Polyline 3D vazia.
6. Obter o Alinhamento associado ao Profile View para extrair as coordenadas Easting e Northing.
7. Percorrer os PVI (Pontos de Intersecção Vertical) do profile criado.
8. Adicionar as coordenadas e elevações dos PVI à Polyline 3D.
9. Adicionar a Polyline 3D ao Model.

Abaixo irei explicar com código cada etapa:
...
```
7. Percorrer os PVI (Pontos de Intersecção Vertical) do profile criado e adicionar as coordenadas e elevações dos PVI à Polyline 3D.
```csharp
...
```
8. Adicionar a Polyline 3D ao Model e remover o Profile criado.
```csharp
